...
namespace BefunCompile.Graph.Vertex
{
	public class BCVertexExprVarSet : BCVertex, MemoryAccess
	{
		...
		public BCVertexExprVarSet(BCDirection d, Vec2i pos, ExpressionVariable var)
		...
		{
			return new BCVertexExprVarSet(Direction, Positions, Variable);
		}
		...
		{
			return new BCVertexTotalVarSet(Direction, Positions, Variable, access.Single().Value.Replacement);
		}
	}
}
